                    ...
                    <div class="card"  style="margin-left: 500px; width: 800px; margin-top: 50px">
                      ...
                      <div class="card-body card-block">
                        <form action="" method="post" >
                            ...
                            <br>
                            <select id="shoes" name="shoes" style="width:755px; height: 35px" value="<?php echo $shoes ?>">
                                    <option value="shoe" selected>Select Type of Shoes</option>
                                    <option value="Flat Shoes" <?php if($shoes=="Flat Shoes") echo 'selected="selected"'; ?>>Flat Shoes</option>
                                    <option value="Sandals" <?php if($shoes=="Sandals") echo 'selected="selected"'; ?>>Sandals</option>
                                    <option value="with Heels" <?php if($shoes=="with Heels") echo 'selected="selected"'; ?>>with Heels</option>
                                </select>
                            </div>
                            <!-- upper color -->
                            ...
                            <select id="color" name="color" style="width:755px; height: 35px">
                                    ...
                                    <option value="Red" <?php if($upper=="Red") echo 'selected="selected"'; ?>>Red</option>
                                    <option value="Blue" <?php if($upper=="Blue") echo 'selected="selected"'; ?>>Blue</option>
                                    <option value="Black" <?php if($upper=="Black") echo 'selected="selected"'; ?>>Black</option>
                                    <option value="Yellow" <?php if($upper=="Yellow") echo 'selected="selected"'; ?>>Yellow</option>
                                    <option value="Gray" <?php if($upper=="Gray") echo 'selected="selected"'; ?>>Gray</option>
                                </select>
                            </div>
                            <!-- insole -->
                            ...
                            <select id="insole" name="insole" style="width:755px; height: 35px">
                                    ...
                                    <option value="Plain" <?php if($sole=="Plain") echo 'selected="selected"'; ?>>Plain</option>
                            ...
                            <br>
                            <select id="status" name="status" style="width:755px; height: 35px">
                                    <option value="status" selected>Select Delivery Status</option>
